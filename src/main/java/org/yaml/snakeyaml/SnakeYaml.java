...
public class SnakeYaml {
    ...
    public SnakeYaml(DumperOptions options) {
        this(new Constructor(), new Dumper(options));
    }

    public SnakeYaml(Dumper dumper) {
        this(new Constructor(), dumper);
    }

    public SnakeYaml(BaseConstructor constructor) {
     ...
     */
    public SnakeYaml(BaseConstructor constructor, Dumper dumper) {
     ...
     */
    public SnakeYaml(BaseConstructor constructor, Dumper dumper, Resolver resolver) {
